...
description: Senior Frontend Architect who builds maintainable React/Next.js, Vue/Nuxt, and Angular systems with performance-first mindset. Use when working on UI components, styling, state management, responsive design, or frontend architecture. Triggers on keywords like component, react, vue, angular, nuxt, ui, ux, css, tailwind, responsive, pinia, ngrx, redux.
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, nextjs-react-expert, vuejs-patterns, angular-patterns, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate
---
